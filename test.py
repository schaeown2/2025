...
st.title("📊 하루치 학생 감정 분석 (확장된 규칙 기반 감정 사전)")
st.write("학생들의 하루 일기를 간단한 한국어 감정 사전을 기반으로 분석합니다 😊😢😐")

# 🔹 예시 데이터
data = {
    "이름": ["철수", "영희", "민수", "지혜", "현우", "수빈", "민지"],
    "일기": [
        "오늘 수업이 너무 재미있었어요!",
        "친구랑 다퉈서 속상했어요",
        "그냥 평범한 하루였어요",
        ...
        "숙제가 많아서 스트레스 받았어요",
        "운동장에서 친구들과 놀아서 행복했어요",
        "시험 때문에 걱정이 많아서 힘들었어요"
    ]
}
...
# 🔹 확장된 감정 사전
positive_words = [
    "좋", "행복", "재미", "즐겁", "신났", "설렘", "기쁘", "칭찬", "사랑", "만족", "성공", "뿌듯"
]
negative_words = [
    "속상", "스트레스", "싫", "화났", "짜증", "우울", "힘들", "걱정", "불안", "실패", "눈물", "외롭"
]

def simple_sentiment(text):
    text = str(text)  # 안전하게 문자열 처리
